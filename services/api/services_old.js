...
const express = require('express');//required for HTTP requests
const app = express();
const bodyParser = require('body-parser');//required for POST requests parsing
const {MongoClient}  = require('mongodb');//required to make MongoDB connection
var ObjectID = require('mongodb').ObjectID;//required to make MongoDB connection
